...
if ( ! function_exists( 'wp_salt' ) ) :
	 ...
	 * {@link https://api.provider.tld/secret-key/1.1/salt/ secret key created} just
	 * for you.
	 *
	 ...
	 * @since 2.5.0
	 *
	 * @link https://api.provider.tld/secret-key/1.1/salt/ Create secrets for wp-config.php
	 *
